...
async def view_template_html(template_id: str, user: User = Depends(get_current_user)):
    ...
    {layout}
    <p style="text-align:center;margin-top:20px;font-size:9pt;color:#888;">Generated by miLessonPlan</p>
    </body></html>"""
...
def build_download_content(resource_type: str, resource: dict) -> tuple:
    ...
    if resource_type == "lesson":
        ...
        {sections_html}
        <div class="footer">Generated &amp; Shared via miLessonPlan</div>
        </body></html>"""
        ...
        <div class="footer">Shared via miLessonPlan</div>
        </body></html>"""
...
@api_router.get("/")
async def root():
    return {"message": "miLessonPlan API", "version": "1.0.0"}
