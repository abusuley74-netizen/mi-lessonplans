...
print("Testing Arabic text encoding in PDF generation...")
try:
    pdf_bytes = _html_to_pdf(arabic_html)
...
print("\nTesting Latin text encoding in PDF generation...")
try:
    pdf_bytes = _html_to_pdf(latin_html)
    print(f"✓ PDF generated successfully: {len(pdf_bytes)} bytes")
except Exception as e:
    print(f"✗ Error: {type(e).__name__}: {e}")