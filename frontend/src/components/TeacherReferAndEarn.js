  ...
  const shareOnSocial = (platform) => {
    ...
    switch (platform) {
      ...
      case 'twitter':
        ...
        break;
      case 'email':
        shareUrl = `mailto:?subject=${encodeURIComponent('Join Mi-LessonPlan')}&body=${encodeURIComponent(text + '\n\n' + codeData.referral_link)}`;
        break;
      default: return;
    }
  ...
  return (
    <div className="space-y-6" data-testid="teacher-refer-earn">
      ...
      <div>
        ...
        <p className="text-[#7A8A76]">Share Mi-LessonPlan with fellow teachers and earn 30% commission on every subscription!</p>
      </div>
