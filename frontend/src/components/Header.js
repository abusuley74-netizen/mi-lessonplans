...
import { LayoutDashboard, LogOut, Crown, Menu, X, BookOpen } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#D5E8D0] border-b border-[#B8D4B0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/dashboard" className="flex items-center gap-2" data-testid="logo-link">
            <img src={LOGO_URL} alt="mi-lessonplan.site" className="w-9 h-9 rounded-md object-contain" />
            <span className="font-heading font-bold text-xl text-[#1A2E16]">mi-lessonplan.site</span>
          </Link>
