...
const AdminReferAndEarn = () => {
  ...
  const shareOnSocial = (platform) => {
    ...
    switch (platform) {
      ...
      case 'email': shareUrl = `mailto:?subject=${encodeURIComponent('Join miLessonPlan')}&body=${encodeURIComponent(text + '\n\n' + codeData.referral_link)}`; break;
      default: return;
    }
  ...
  return (
    <div className="p-6 space-y-6" data-testid="admin-refer-earn">
      ...
      <div>
        ...
        <p className="text-gray-500">Share miLessonPlan and earn 30% commission on every subscription!</p>
      </div>
