        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-white/80">
              {user?.subscription_plan === 'free' && '20 lesson plans per month'}
              {user?.subscription_plan === 'basic' && '50 lesson plans per month'}
              {user?.subscription_plan === 'premium' && 'Unlimited lesson plans'}
            </p>
          </div>
